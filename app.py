...
# ==================================
# Bagian 1: CSS CUSTOM (LOCKED & COLOR FIXED)
# ==================================
st.markdown("""
<style>
    ...
    /* HIJAU MUDA GRADASI UNTUK PARTISIPASI */
    ...
    .tile-label { font-size: 11px; font-weight: 600; opacity: 0.9; text-transform: uppercase; }
