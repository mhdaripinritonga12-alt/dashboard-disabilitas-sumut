    ...
    with col_card:
        with st.container(border=True):
            ...
            with col_r:
                ...
                st.caption("Dashboard SI-CERDAS SUMUT")
...
if logo_b64:
    st.sidebar.markdown(f'<div style="display: flex; align-items: center; gap: 12px; padding-bottom: 20px;"><img src="data:image/png;base64,{logo_b64}" width="45"><span style="font-size: 18px; font-weight: 800; color: white;">SI-CERDAS</span></div>', unsafe_allow_html=True)
