...
if st.session_state.page_view == "dashboard":
    st.markdown(f'<p style="font-size:26px; font-weight:800; color:#0d47a1;">🚀 Dashboard - {kab_pilih}</p>', unsafe_allow_html=True)
    ...
    with m4:
        ...
        st.metric("Partisipasi", f"{val_aps:.2f}%")
...
# ==================================
    ...
    search_q = f"{sch['nama_sekolah'].replace(' ', '+')}+{sch['kab_kota'].replace(' ', '+')}"
    components.html(f'<iframe width="100%" height="350" frameborder="0" src="https://www.google.com/maps?q={search_q}&output=embed" style="border-radius:15px; border:1px solid #ddd;"></iframe>', height=370)
