...
.streamlit-expanderHeader svg {
   ...
   .source-box-ui {background-color: #fff3e0 !important; /* Warna Orens sangat muda */ padding: 8px 12px; border-radius: 8px; border-left: 5px solid #ff9800; */margin-bottom: 100px;}
