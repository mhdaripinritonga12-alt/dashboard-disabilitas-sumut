...
if st.session_state.page_view == "dashboard":
    ...
    with m1: draw_tile_svg("Penduduk Disabilitas", val_p, svg_people, "tile-orange-light")
    with m2: draw_tile_svg("Siswa Belajar", val_s, svg_cap, "tile-blue-light")
    with m3: draw_tile_svg("Anak Tidak Sekolah", val_a, svg_warning, "tile-blue-dark-light")
