...
<style>
    ...
    .tile-label { font-size: 18px; font-weight: 600; text-transform: uppercase; }
...
svg_chart = '<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round">
  <path d="M4 14 L9 9 L13 13 L20 6"></path>
</svg>
'
# ==================================
# Bagian 2: LOAD DATA
