...
<style>
    ...
    .source-box-ui { 
        background-color: #fff3e0 !important; padding: 4px 12px !important; 
        border-radius: 8px; border-left: 5px solid #ff9800; 
        width: 100% !important; display: block !important; box-sizing: border-box;
    }

    /* --- SIDEBAR DESIGN (ULTRA SLIM & RAPAT) --- */
    [data-testid="stSidebar"] { background: linear-gradient(180deg, #1e88e5 0%, #0d47a1 100%) !important; }
    [data-testid="stSidebar"] * { color: white !important; }

    /* Menghilangkan jarak antar widget di sidebar */
    ...
    /* Gaya Tombol Sidebar (ULTRA SLIM & PANJANG) */
    section[data-testid="stSidebar"] .stButton button {
        background-color: rgba(255, 255, 255, 0.1) !important;
        color: white !important; border: 1px solid rgba(255, 255, 255, 0.2) !important;
        border-radius: 8px !important; width: 100% !important;
        font-weight: 600 !important; text-align: left !important;
        padding: 2px 12px !important; /* Tinggi tombol sangat tipis */
    ...
    div.logout-btn-container section[data-testid="stSidebar"] .stButton button {
...
if st.session_state.page_view == "dashboard":
    st.markdown('<p style="font-size:22px; font-weight:800; color:#0d47a1; margin-bottom: 2px;">Matriks Capaian Sektoral</p>', unsafe_allow_html=True)
    st.markdown("""<div class="source-box-ui"><p style="font-size: 11px; color: #e65100; margin: 0; font-weight: 700;"><b>ℹ️ Sumber Data:</b> Bidang Pendidikan Khusus, Data LPPD & TIKP Provsu 2025</p></div>""", unsafe_allow_html=True)
    ...
    with st.expander("📋 Lihat & Download Data Tabel"):
        ...
        st.download_button(label="Download CSV 📥", data=csv, file_name=f'data_ats_{kab_pilih}.csv', mime='text/csv')
